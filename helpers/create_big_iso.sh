...
[ -f rhcos-live.x86_64.iso ] || curl https://mirror.openshift.com/pub/openshift-v4/dependencies/rhcos/pre-release/latest-4.6/rhcos-live.x86_64.iso > rhcos-live.x86_64.iso
